...
class reaApp(QtGui.QMainWindow, reagui.Ui_REAWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.btnRun.clicked.connect(self.userOK)
...
class dataWorker(QtCore.QThread):
    ...
    def process(self):    
        ...
        i=1
        while (exists(fnameIn+'/echoAmps%d.csv'%i)):
            i+=1
        numMeasures=i-1
...
#        
        ...
        if doAverage:
            ...
            if not fnameOut.endswith('.mat'):
                fnameOut = fnameOut + '.mat'
            sio.savemat(fnameOut,{'phasedEchoData':fullData,'echoCentreTime':echoAmpsX,'measureTime':measureTime})
